                    ...
                    if (isset($sink-> {'parameters'})) {
                        ...
                        foreach ($parameters as $parameter) {
                            if (isset($parameter-> {'id'}) && is_int($parameter-> {'id'})) {
                                ...
                                // code add by Cm0s
                                if (isset($parameter-> {'check_param'}) && !empty($parameter-> {'check_param'})) {
                                    $mySink->addParameter($parameter-> {'id'}, $parameter-> {'check_param'});
                                }
                            }
                        }
                    ...
                    if (isset($source-> {'parameters'})) {
                        ...
                        foreach ($parameters as $parameter) {
                            if (is_int($parameter-> {'id'})) {
                                ...
                                // Add code by Cm0s
                                if (isset($parameter-> {'check_value'}) && $parameter-> {'check_value'}) {
                                    $mySource->addconditionsParameter(
                                        $parameter-> {'id'},
                                        MySource::CONDITION_VALUE,
